...
function PendingMedicines() {
  ...
  const currentMedicines = pendingMedicines || [];
  ...
  // ⛔ IMPORTANT — READ FROM medicine.medicineId  
  const getValue = (medicine, key) => {
    const med = medicine.medicineId || {}; // safe
        ...
        return (
          ...
          >
            <button
              ...
              onClick={() => approveMedicine(medicine._id)}
            >
              Approve
            </button>
            ...
            <button
              ...
              onClick={() => rejectMedicine(medicine._id)}
            >
              Reject
            </button>
          </div>
