...
const AvailabilityManagement = () => {
  const {
    ...
    createAvailability2: createAvailability,
    getVendorAvailabilities2: getVendorAvailabilities,
    getAvailabilityByDateRange2: getAvailabilityByDateRange,
    deleteAvailability2: deleteAvailability
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success === 1) {
      ...
      setActiveTab('allSlots'); // Switch to all slots tab
    } else {
                ...
                <Tab eventKey="allSlots" title={
                  ...
                  <div className="mt-4">
                    ...
                    {loading ? (
                      ...
                      <Alert variant="info">
                        No availability slots found. Add a new slot to get started.
                      </Alert>
                    ) : (
                      <>
                          ...
                          <Table striped bordered hover className="mb-0">
                            ...
                            <tbody>
                              {availabilities.map((avail) => (
                                <tr key={avail._id}>
                                  <td>
                                    <Badge bg="info" className="text-capitalize">{avail.day}</Badge>
                                  </td>
                                  <td>
                        ...
                        {dateRangeAvailability.length > 0 && (
                          <div className="mt-5">
                            <h5 className="mb-3">
                              ...
                              Filtered Results: {formatDate(dateRange.startDate)} to {formatDate(dateRange.endDate)}
                            </h5>
                            <div className="table-responsive">
                  ...
                  <div className="mt-4">
                    ...
                    <div className="mt-4">
                      <Card className="border-primary">
                        ...
                        <Card.Body>
                          <ul className="mb-0">
                            <li>Morning: 01:00 AM - 12:00 PM</li>
                            <li>Afternoon: 12:00 PM - 06:00 PM</li>
                            <li>Evening: 06:00 PM - 12:00 AM</li>
                            <li>Select specific time slots within these periods</li>
                            <li>You can create multiple slots for the same date range</li>
                          </ul>
                        </Card.Body>
                      </Card>
                    </div>
