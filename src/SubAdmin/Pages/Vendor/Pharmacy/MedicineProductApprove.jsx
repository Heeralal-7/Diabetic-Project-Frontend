import React, {
  ...
  // Memoized Image Component (Same as Admin)
  ...
  function PendingMedicinesProductSub() {
    // ✅ Context se Sub-Admin wale variables aur functions nikale
    const {
      pendingProductsSub,          // State from Context (Sub-Admin data)
      getPendingMedicineProductsSub, // Function to fetch (Sub-Admin API)
      updateProductStatusSub       // Function for Approve/Reject (Sub-Admin API)
    ...
    // ✅ UseEffect me Sub-Admin wala fetch function call kiya
    useEffect(() => {
      getPendingMedicineProductsSub();
      // eslint-disable-next-line
    }, []);
 
    // ✅ Data source update kiya
    const currentProducts = pendingProductsSub || [];
      ...
      switch (header.key) {
        ...
        case "actions":
          return (
            ...
            >
              {/* ✅ Sub-Admin Approve Button: Status 0 */}
              <button
                className="btn btn-success btn-sm"
                onClick={() => updateProductStatusSub(product._id, 0)}
              >
                Approve
              </button>
 
              {/* ✅ Sub-Admin Reject Button: Status 1 */}
              <button
                className="btn btn-danger btn-sm"
                onClick={() => updateProductStatusSub(product._id, 1)}
              >
                Reject
              </button>
            </div>
          ...
          <div className="card">
            <div className="card-header d-flex justify-content-between">
              <h3 className="mb-0 text-primary">
                Hospital Products (Sub-Admin) ({currentProducts.length})
              </h3>
            </div>
  ...
  // ✅ Correct Component Name Export
  export default PendingMedicinesProductSub;
