...
import "../../../../Admin/Assests/css/MedicineProduct.css"; // Ensure this path is correct for your project
...
const MedicineProduct = () => {
  ...
  const {
    ...
    loading,
    uploadProgress,
    getAllProductsSubadmin:fetchAllProducts,
    uploadProductExcelSubadmin:uploadProductExcel,
    updateProductSubadmin:updateMedicineProduct,
    deleteProductSubadmin:deleteProduct,
    deleteMultipleProductsSubadmin:deleteMultipleProducts,
    isDeleting
