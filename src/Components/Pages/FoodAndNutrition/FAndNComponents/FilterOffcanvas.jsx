...
return (
<>
  <div className="noBackdrop offcanvas OfcanvasH-80 CustomOffcan-lg-end offcanHeightFull" tabIndex={-1} id="Filter"
    ...
    <div className="offcanvas-body pb-0">
      ...
      <div className="py-2 bg-light  w-100 sticky-bottom">
        <button type="submit" className="btn w-100 py-3 bg-mainRed  fs-5 my-1 text-light fw-semibold rounded-2 ">
          Apply Filters
        </button>
      </div>
    </div>
