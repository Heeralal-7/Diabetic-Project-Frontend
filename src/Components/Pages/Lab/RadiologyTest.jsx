...
const RadiologyTests = () => {
  ...
  const radiologyTests = test.filter(
    (t) => t.testCategory === "Radiology"
  );
  ...
  const openCart = () => {
    bootstrap.Offcanvas.getOrCreateInstance(
      document.getElementById("RadiologyCart")
    ).show();
  };
        ...
        <div className="d-flex justify-content-between align-items-center mb-5">
          <div>
            <h2 className="fw-bold text-success mb-1">
              <i className="ri-camera-lens-line me-2"></i>All Radiology Tests
            </h2>
            <p className="text-muted mb-0">
              Complete list of all available radiology diagnostic tests
            </p>
          </div>
