...
import "../Medicine/medical.css"
import { MyContext } from "../../../Context/Context";

function MedicinesSA() {
  ...
  const [savingMedicine, setSavingMedicine] = useState(null); // Track which medicine is being saved
  ...
  return (
    <div className="container-fluid px-4 py-5">
      <h1 className="display-5 fw-bold mb-4 text-center text-primary">Medicines Database</h1>
