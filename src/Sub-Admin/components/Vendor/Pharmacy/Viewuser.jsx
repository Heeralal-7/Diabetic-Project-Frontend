                          ...
                          <td>
                            <div className="btn-group">
                              {editingIndex === i ? (
                                <>
                                  <button
                                    className="btn btn-secondary bg-opacity-25 bg-gradient mx-1"
                                    type="button"
                            ...
                            <td>
                              <div className="btn-group">
                                ...
                                <ul className="dropdown-menu">
                                  ...
                                  <li>
                                    <a
                                      className="ps-3 dropdown-item cursor-pointer"
                                ...
                                <ul className="dropdown-menu">
                                  ...
                                  <li>
                                    <a
                                      ...
                                      style={{ cursor: "pointer" }}
                                      onClick={() => {
                                        handleClickValue("registrationNo");
                                      }}
                                    >
                                      Reject
                                    </a>
...
export default ViewUserPharmacy;
