...
//       await deleteSub(mainFormId, subheadingId); // Call the function to delete the subheading
//       await partBlog(id); // Refresh the blog data after deletion
//     } catch (error) {
...
//   useEffect(() => {
//     // Prefill formData2 when particularBlog is updated
//     if (particularBlog) {
//       setFormData2({
...
//         blogimage: particularBlog.blogimage || null, // Assuming you're not prefilling the image field
//       });
//     }
//   }, [particularBlog]);
...
//               onChange={handleChange} 
//             />
//             {particularBlog.blogimage && (
//               <div className="my-3">
//                 <img
//                    src={`${URL}/${particularBlog.blogimage}`}
//                   alt="Existing Blog"
//                   style={{
...
//                     justifyContent: "center" // Adds a subtle shadow for depth
//                   }}
//                 />
//               </div>
//             )}
...
//               <div
//                 key={index}
//                 className="d-flex col-md-12 align-items-center gap-3"
//               >
//                 <div className="w-75">
//                   <label
//                     htmlFor={`UpdateSubHeading-${index}`}
//                     className="form-label fw-semibold fs-5"
//                   >
...
//                   <input
//                     className="form-control"
//                     id={`UpdateSubHeading-${index}`}
//                     name="conclusion"
//                     rows="3"
//                     value={`Title - ${subheading.title}`}
//                     readOnly // Ensure this is read-only
//                   ></input>
//                 </div>
//                 <div>
//                   <button
...
export default GetParticularBlogSA;
